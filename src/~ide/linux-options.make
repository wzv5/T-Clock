...
INC = 
CFLAGS = -D_UNICODE -DUNICODE -fno-ident -Wall -m32 -fvisibility=hidden -ffunction-sections -fno-asynchronous-unwind-tables -D_POSIX=1 -D_POSIX_C_SOURCE=200112L -D__STDC_FORMAT_MACROS -D__USE_MINGW_ANSI_STDIO=0 -D__MINGW_USE_VC2005_COMPAT -DWINVER=0x0501 -DPSAPI_VERSION=1 -DWIN2K_COMPAT
RESINC = 
LIBDIR = -Llib32
...
before_release: 
	...
	test -d $(OBJDIR_RELEASE)/__/options || mkdir -p $(OBJDIR_RELEASE)/__/options
...
clean_release: 
	...
	rm -rf $(OBJDIR_RELEASE)/__/options
	rm -rf $(OBJDIR_RELEASE)/__/common

before_debug: 
	test -d ../../Debug/misc || mkdir -p ../../Debug/misc
	test -d $(OBJDIR_DEBUG)/__/options || mkdir -p $(OBJDIR_DEBUG)/__/options
